...
- (GPGStream *)dataForOneFile:(NSArray *)files;   // take lastObject
- (GPGStream *)dataForDirectory:(NSArray *)files; // take lastObject
- (GPGStream *)dataForFiles:(NSArray *)files;
...
- (NSData *)dataForOneFile:(NSArray *)files {
    return [GPGFileStream fileStreamForReadingAtPath:[files lastObject]];
}
